...
1. When the viewport is less than 600px wide, the third item will display next
to the second one.
1. When the viewport is at least 600px wide, the third item will be pushed to
